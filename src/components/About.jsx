...
const About = () => {
    return (
        <div id="about" className='flex flex-col px-6 py-24 max-h-screen border border-b-white/20'>
            <div className="max-w-5xl mx-auto grid grid-cols-2  gap-8 md:w-full">
                <div className="flex-1">
                    ...
                    <h1 className='text-[#ebebed] text-5xl font-bold mb-8'>A Developer Who <br />Actually Ships</h1>
                ...
                <div className="flex-1 flex flex-col gap-8">
                    <div className="border border-white/20 p-6 hover:border-[#818CF8] transition-all duration-300 flex gap-4">
                        ...
                        <div className=''>
                            ...
                            <p className='text-2xm text-[#494e57] mb-1'>Aug 2024-May 2027</p>
                    ...
                    <div className="flex justify-between items-center gap-4">
                            <div className="border border-white/20 p-4 hover:border-[#818CF8] transition-all duration-300">
                                <h1 className="text-[#818cf8] font-extrabold text-3xl text-center mb-2">4+</h1>
                                <p className="text-2xm text-[#494e57] text-center ">Project Deployed</p>
                            </div>

                            <div className=" border border-white/20 p-4 hover:border-[#818CF8] transition-all duration-300">
                                <h1 className="text-[#818cf8] font-extrabold text-3xl text-center mb-2">350+</h1>
                                <p className="text-2xm text-[#494e57] text-center ">DSA problem solved</p>
                            </div>

                            <div className="border border-white/20 p-4 hover:border-[#818CF8] transition-all duration-300">
                                <h1 className="text-[#818cf8] font-extrabold text-3xl text-center mb-2">10.00</h1>
                                <p className="text-2xm text-[#494e57] text-center ">Current CGPA</p>
                            </div>
                    </div>

                    <div className="border border-white/20 p-4 hover:border-[#818CF8] transition-all duration-300">
                        <h1 className="text-[#494e57] text-lg mb-4">CONTACTS:</h1>
